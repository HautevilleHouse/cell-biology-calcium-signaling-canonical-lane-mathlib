import CellBiologyCalciumSignalingCanonicalLaneLean.CalciumWaveRoute

namespace HautevilleHouse
namespace CellBiologyCalciumSignalingCanonicalLaneLean

structure CurvatureAnalyticCertificate (G : IP3ReceptorBindingPackage) where
  ...
  curvatureEvidence : IP3ReceptorBindingEvidence G

def CurvatureAnalyticCertificateClosed {G : IP3ReceptorBindingPackage}
  ...
  IP3ReceptorBindingClosed G

theorem curvature_analytic_certificate_closed
    {G : IP3ReceptorBindingPackage} (C : CurvatureAnalyticCertificate G) :
      ...
      (And.intro C.ricciContractionLawClosed
        (And.intro C.scalarTraceLawClosed
          (And.intro C.curvatureEvolutionInputsClosed
            (ip3_receptor_binding_closed_from_evidence G C.curvatureEvidence)))))

structure CalciumFluxPDEAnalyticCertificate {G : IP3ReceptorBindingPackage}
    (F : CalciumFluxPDEPackage G) where
  gaugeChoice : Prop
  stronglyParabolicReduction : Prop
  deTurckVectorField : Prop
  pullbackRecoversCalciumFlux : Prop
  ...
  pullbackRecoversCalciumFluxClosed : pullbackRecoversCalciumFlux
  uniquenessCompatibilityClosed : uniquenessCompatibility
  flowEvidence : CalciumFluxPDEEvidence F

def CalciumFluxPDEAnalyticCertificateClosed {G : IP3ReceptorBindingPackage}
    {F : CalciumFluxPDEPackage G} (H : CalciumFluxPDEAnalyticCertificate F) : Prop :=
  H.gaugeChoice ∧
  H.stronglyParabolicReduction ∧
  H.deTurckVectorField ∧
  H.pullbackRecoversCalciumFlux ∧
  H.uniquenessCompatibility ∧
  CalciumFluxPDEClosed F

theorem calcium_flux_pde_analytic_certificate_closed
    {G : IP3ReceptorBindingPackage} {F : CalciumFluxPDEPackage G}
    (H : CalciumFluxPDEAnalyticCertificate F) :
    CalciumFluxPDEAnalyticCertificateClosed H := by
  exact And.intro H.gaugeChoiceClosed
    (And.intro H.stronglyParabolicReductionClosed
      (And.intro H.deTurckVectorFieldClosed
        (And.intro H.pullbackRecoversCalciumFluxClosed
          (And.intro H.uniquenessCompatibilityClosed
            (calcium_flux_pde_closed_from_evidence F H.flowEvidence)))))

structure ShortTimeAnalyticCertificate {G : IP3ReceptorBindingPackage}
    {F : CalciumFluxPDEPackage G} (S : ShortTimeExistencePackage F) where
...
def ShortTimeAnalyticCertificateClosed {G : IP3ReceptorBindingPackage}
...
structure EntropyAnalyticCertificate {G : IP3ReceptorBindingPackage}
    {F : CalciumFluxPDEPackage G} {S : ShortTimeExistencePackage F}
    (E : CalciumWaveEntropyPackage S) where
  ...
  entropyEvidence : CalciumWaveEntropyEvidence E

def EntropyAnalyticCertificateClosed {G : IP3ReceptorBindingPackage}
    {F : CalciumFluxPDEPackage G} {S : ShortTimeExistencePackage F}
    {E : CalciumWaveEntropyPackage S} (C : EntropyAnalyticCertificate E) : Prop :=
  C.conjugateHeatEquation ∧
  C.wFunctionalDefined ∧
  C.muFunctionalDefined ∧
  C.entropyMonotonicityFormula ∧
  C.reducedVolumeMonotonicity ∧
  CalciumWaveEntropyClosed E

theorem entropy_analytic_certificate_closed
    {G : IP3ReceptorBindingPackage} {F : CalciumFluxPDEPackage G}
    {S : ShortTimeExistencePackage F} {E : CalciumWaveEntropyPackage S}
      ...
      (And.intro C.muFunctionalDefinedClosed
        (And.intro C.entropyMonotonicityFormulaClosed
          (And.intro C.reducedVolumeMonotonicityClosed
            (calcium_wave_entropy_closed_from_evidence E C.entropyEvidence)))))

structure NoncollapsingAnalyticCertificate {G : IP3ReceptorBindingPackage}
    {F : CalciumFluxPDEPackage G} {S : ShortTimeExistencePackage F}
    {E : CalciumWaveEntropyPackage S} (N : NoncollapsingPackage E) where
...
def NoncollapsingAnalyticCertificateClosed {G : IP3ReceptorBindingPackage}
    {F : CalciumFluxPDEPackage G} {S : ShortTimeExistencePackage F}
...
structure SingularityAnalyticCertificate {G : IP3ReceptorBindingPackage}
    {F : CalciumFluxPDEPackage G} {S : ShortTimeExistencePackage F}
    {E : CalciumWaveEntropyPackage S} {N : NoncollapsingPackage E}
    (Q : CalciumWaveSingularityModelsPackage N) where
  ...
  singularityEvidence : CalciumWaveSingularityModelsEvidence Q

def SingularityAnalyticCertificateClosed {G : IP3ReceptorBindingPackage}
    {F : CalciumFluxPDEPackage G} {S : ShortTimeExistencePackage F}
    {E : CalciumWaveEntropyPackage S} {N : NoncollapsingPackage E}
    {Q : CalciumWaveSingularityModelsPackage N} (C : SingularityAnalyticCertificate Q) : Prop :=
  C.blowupSequenceChosen ∧
  C.pointedLimitExists ∧
  C.ancientKappaSolution ∧
  C.asymptoticShrinkersControlled ∧
  CalciumWaveSingularityModelsClosed Q

theorem singularity_analytic_certificate_closed
    {G : IP3ReceptorBindingPackage} {F : CalciumFluxPDEPackage G}
    {S : ShortTimeExistencePackage F} {E : CalciumWaveEntropyPackage S}
    {N : NoncollapsingPackage E} {Q : CalciumWaveSingularityModelsPackage N}
    ...
    (And.intro C.pointedLimitExistsClosed
      (And.intro C.ancientKappaSolutionClosed
        (And.intro C.asymptoticShrinkersControlledClosed
          (calcium_wave_singularity_models_closed_from_evidence Q C.singularityEvidence))))

structure CanonicalNeighborhoodAnalyticCertificate {G : IP3ReceptorBindingPackage}
    {F : CalciumFluxPDEPackage G} {S : ShortTimeExistencePackage F}
    {E : CalciumWaveEntropyPackage S} {N : NoncollapsingPackage E}
    {Q : CalciumWaveSingularityModelsPackage N} (C : CanonicalNeighborhoodsPackage Q) where
...
def CanonicalNeighborhoodAnalyticCertificateClosed {G : IP3ReceptorBindingPackage}
    {F : CalciumFluxPDEPackage G} {S : ShortTimeExistencePackage F}
    {E : CalciumWaveEntropyPackage S} {N : NoncollapsingPackage E}
